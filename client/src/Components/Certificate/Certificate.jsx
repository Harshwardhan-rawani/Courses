  ...
  return (
    <>
       <motion.div
        ...
        viewport={{once:true}}
        className="flex md:flex-row-reverse flex-col lg:space-x-10 space-y-4 p-4 lg:mx-20 mx-10"
      >
        <motion.div
          initial={{ opacity: 0 }}
        ...
        >
          <img src={image}  className=" shadow-lg  w-full" />
        </motion.div>
        ...
        >
          <h1 className="text-2xl text-center font-bold mb-2 text-orange-400">Certificate</h1>
